			...
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
				...
				<div class="collapse navbar-collapse " id="navbarNav">
					...
					<ul class="navbar-nav navbar-right">
						<li class="nav-item"><a href="#" class="nav-link">Bumwe Levy</a></li>
					
					
							<li class="nav-item active table-active " style="height:60px;background-color: black"><a href="#" class="nav-link">List of Members</a></li>
							<li class="nav-item" style="background-color:unset; border-radius: 20px; text-decoration:none;"><a href ="#" style="color: #fff;text-decoration:none;" class="nav-link">Edit Profil</a></li>
					...
					<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-6 offset-md-3">
								...
								<!-- form card register -->
								<div class="card card-outline-secondary">
									<div class="card-header" style="background-color: #8a6d3b">
