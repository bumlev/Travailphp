...
<div class="navbar navbar-fixed-top">
	...
	<div class="navbar-inner">
		...
		<div class="container">
			...
			<img src="images/somado_logo.png" class="brand" />	
	...
	<tr>
		...
		<div class="add-user">
			...
			?>
				...
				<a class="btn-large-inversed" style="width: 150px; margin-top: 20px; position: absolute; height: 28px; margin-left: 20px;" href="<?php if(isset($_SESSION['codeR'])){ echo 'patients1.php?';}else{ if($comptidDoc!=0){echo 'medecins1.php?';} if($comptidInf!=0){ echo'infirmiers1.php?';} if($comptidLabo!=0){ echo'laborantins1.php?';} if($comptidRadio!=0){ echo'radiologues1.php?';} if($comptidMan!=0){ echo 'coordinateurs1.php?';} if($comptidRec!=0){ echo'receptionistes1.php?';} if($comptidCash!=0){ echo 'caissiers1.php?';} if($comptidAudit!=0){ echo 'auditeurs1.php?';}if($comptidAcc!=0){ echo 'comptables1.php?';}}?><?php if(isset($_GET['english'])){ echo 'english='.$_GET['english'];}else{if(isset($_GET['francais'])){ echo 'francais='.$_GET['francais'];}}?><?php if(isset($_GET['caissier'])){ echo '&caissier='.$_GET['caissier'];}else{ if(isset($_GET['receptioniste'])){ echo '&receptioniste='.$_GET['receptioniste'];}}?>">
...
<div>
	<footer style="bottom: 0px; width: 100%; text-align: center; background: #fff; border-top: 1px solid #eee; padding: 10px 0px; vertical-align: middle;">
		<p style="margin:0"><span style="color:#a00000">Clinic Plus®</span> is a product of <span style="font-style:bold;">Ikorere Group Limited</span>. ©2015-2016 All rights reserved.</p>
	</footer>
</div>
